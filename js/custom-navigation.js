...
$(window).on("scroll", function () {
  if ($(window).scrollTop()) {
    $("nav.navbar#mynavbar.navbar-custom.navbar-transparent").addClass(
      "white-color"
    );
  } else {
    $("nav.navbar#mynavbar.navbar-custom.navbar-transparent").removeClass(
      "white-color"
    );
  }
});
...
$(window).on("scroll", function () {
  if ($(window).scrollTop()) {
    $(
      ".main-navbar#mynavbar nav.navbar#mynavbar .navbar-search-link > li:last-child a"
    ).addClass("black-color1");
  } else {
    $(
      ".main-navbar#mynavbar nav.navbar#mynavbar .navbar-search-link > li:last-child a"
    ).removeClass("black-color1");
  }
});
...
$(
  ".nav-pills .nav-item .nav-link:not(.nav-pills .nav-item .nav-link), .nav-tabs"
).click(function () {
